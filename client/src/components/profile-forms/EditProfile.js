      ...
      <form className="form" onSubmit={e=>onSubmit(e)}>
        ...
        <div className="my-2">
         ...
         {displaySocialInputs && <Fragment>
          ...
          <input type="text" placeholder="Twitter URL" onChange={e=>onchange(e)} value={twitter} name="twitter" />
        </div>

        <div className="form-group social-input">
          <i className="fab fa-facebook fa-2x"></i>
          <input type="text" placeholder="Facebook URL" onChange={e=>onchange(e)} value={facebook} name="facebook" />
        </div>
